(function (root, factory) {
  ...
  function getContact(search) {
    if (parseContext(search).contactMode === "upwork") {
      return {
        ...
        description: "Use my Upwork profile to message me about the workflow you want simplified.",
        href: UPWORK_PROFILE,
        external: true,
      };
    }
    return {
      ...
      description: "Tell me which workflow you want simplified.",
      href: `mailto:${EMAIL}`,
      external: false,
    };
  }
  ...
  function renderCta(container, options) {
    ...
    heading.textContent = "Have a similar workflow?";
